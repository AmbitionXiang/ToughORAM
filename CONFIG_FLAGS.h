...
enum PATHORAM_TIMER { PO_POSMAP_START,
                      PO_POSMAP_END,
                      PO_DOWNLOAD_PATH_START,
                      PO_DOWNLOAD_PATH_END,
                      PO_FETCH_BLOCK_START,
                      PO_FETCH_BLOCK_END,
                      PO_EVICTION_START,
                      PO_EVICTION_END,
                      PO_UPLOAD_PATH_START,
                      PO_UPLOAD_PATH_END };

enum CIRCUITORAM_TIMER { CO_POSMAP_START,
                         CO_POSMAP_END,
                         CO_FETCH_BLOCK_START,
                         CO_FETCH_BLOCK_END,
                         CO_DOWNLOAD_PATH_START,
                         CO_DOWNLOAD_PATH_END,
                         CO_UPLOAD_PATH_START,
                         CO_UPLOAD_PATH_END,
                         CO_EVICTION_START,
                         CO_EVICTION_END };
